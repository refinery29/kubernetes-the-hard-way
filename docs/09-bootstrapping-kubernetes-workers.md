...
wget -q --show-progress --https-only --timestamping \
  ...
  https://storage.googleapis.com/cri-containerd-release/cri-containerd-1.1.0-rc.0.linux-amd64.tar.gz \
...
```
sudo tar -xvf cri-containerd-1.0.0-rc.0.linux-amd64.tar.gz -C /
```
